...
class AppWindow:
    ...
    def __init__(self, width, height):
        ...
        self.window = gui.Application.instance.create_window(
            "Wheel Chair Curb Mounting Visualization", width, height)
        ...
        # closed. This is useful for property pages, so the user can hide sets
        # of properties they rarely use.
        view_panel = gui.CollapsableVert("Video Panel", 0.25 * em,
                                         gui.Margins(em, 0, 0, 0))
        ...
        view_panel.add_child(self.panel)
        self._video_panel.add_child(view_panel)
        self.window.add_child(self._video_panel)
    ...
    def _on_layout(self, layout_context):
        ...
        height_new = min(
            r.height,
            self._video_panel.calc_preferred_size(
                layout_context, gui.Widget.Constraints()).height)
        self._video_panel.frame = gui.Rect(r.get_right() - width, r.y + height, width,
                                              height_new)
        # self.panel.frame = gui.Rect(r.get_right() - width,
        #                     r.y + height, panel_width,
        #                     panel_width)
